            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('regionIndex') }}">@lang('cruds.region.title')</a></li>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('regionCreate') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{ route('regionIndex') }}" class="btn btn-default float-left">@lang('global.cancel')</a>
                            </div>
                        </form>
