...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('cruds.special-tag.name')</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}">@lang('global.home')</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('special-tagIndex') }}">@lang('cruds.special-tag.name')</a></li>
            ...
            <div class="col-lg-8 offset-lg-2 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('special-tagCreate') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label>@lang('cruds.special-tag.fields.category_type')</label>
                                <select class="select2" name="category_type" style="width: 100%;">
                                    @foreach($categories as $category)
                                        <option value="{{ $category->key }}">{{ $category->name_ru }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-2" id="photo">
                                        ...
                                        <input style="border: 0px; padding-left: 0px" type="file" name="icon" class="form-control" value="{{ old('icon') }}" required>
                                    </div>
