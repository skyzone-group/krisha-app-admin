            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">@lang('cruds.item.title')</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">@lang('cruds.item.title_singular')</h3>
                        @can('item.add')
                            <a href="{{ route('itemAdd') }}" class="btn btn-success btn-sm float-right">
                                    ...
                                    <td class="text-center">
                                        @can('item.delete')
                                            <form action="{{ route('itemDestroy',$item->id) }}" method="post">
                                                ...
                                                <div class="btn-group">
                                                    @can('item.edit')
                                                        <a href="{{ route('itemEdit',$item->id) }}" type="button" class="btn btn-info btn-sm"> @lang('global.edit')</a>
                                                    @endcan
