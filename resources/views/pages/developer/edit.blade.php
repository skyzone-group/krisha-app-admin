            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('developerIndex') }}">@lang('cruds.item.title')</a></li>
            ...
            <div class="col-lg-8 offset-lg-2 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('developerUpdate', $item->id) }}" method="post">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{ route('developerIndex') }}" class="btn btn-default float-left">@lang('global.cancel')</a>
                            </div>
                        </form>
