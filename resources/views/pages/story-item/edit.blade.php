            ...
            <div class="col-lg-8 offset-lg-2 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('story-itemUpdate', $item->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                ...
                                <select class="select2" name="story_category_id" style="width: 100%;">
                                    @foreach($storyCategories as $storyCategory)
                                        <option {{ $item->story_category_id == $storyCategory->id ? 'selected' : '' }} value="{{ $storyCategory->id }}">{{ $storyCategory->title_ru }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-12" id="photo">
                                        ...
                                        <input style="border: 0px; padding-left: 0px" type="file" name="file" class="form-control" value="{{ old('file') }}">
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-12" id="photo">
                                        <label class="col-form-label">@lang('cruds.story-item.fields.file')</label><br>
                                        @if($item->file)
                                                    ...
                                                    @foreach(config('constants.locales') as $locale_second)
                                                        @if($locale['short_name'] == $locale_second['short_name'])
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="title_{{$locale['short_name']}}" class="form-control {{ $errors->has("title_" . $locale['short_name']) ? "is-invalid":"" }}" value="{{ old('title_' . $locale['short_name'], $item->{'title_' . $locale['short_name']}) }}">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea rows="3" name="subtitle_{{$locale['short_name']}}" class="form-control {{ $errors->has("subtitle_" . $locale['short_name']) ? "is-invalid":"" }}" required>{{ old('subtitle_' . $locale['short_name'], $item->{'subtitle_' . $locale['short_name']}) }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control"  name="estate_id" value="{{ old('estate_id', $item->estate_id) }}">
                            </div>
                            <div class="form-group">
